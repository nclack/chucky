...
// Run LOD pipeline for one epoch: gather → reduce → dim0 fold → morton-to-tiles.
// pool_epoch: pointer to this epoch's tile pool region (all levels).
// *out_active_mask: set to bitmask of active LOD levels for this epoch.
